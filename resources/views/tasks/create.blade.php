...
<div class="mx-auto max-w-2xl px-4 py-8 sm:px-6 lg:px-8">
    ...
    <div class="mb-6">
        ...
        <h1 class="mt-2 text-2xl font-bold text-gray-900">New Task</h1>
    </div>

    <form action="{{ route('tasks.store') }}" method="POST" class="space-y-5 rounded-2xl border border-gray-200 bg-white p-8 shadow-sm">
        @csrf
